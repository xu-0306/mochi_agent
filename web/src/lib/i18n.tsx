...
const messages: Record<UILanguage, Record<TranslationKey, string>> = {
  'zh-TW': {
    ...
    'sidebar.primaryHintTitle': 'Chat 是主要入口',
    'sidebar.primaryHintDescription': '先在聊天中建立與引導目標。下方頁面保留給檢查、恢復與進階操作。',
    'sidebar.advancedTools': '進階面板',
    'sidebar.goalConsole': '目標主控台',
    'sidebar.goalConsoleDescription': '檢查長任務、預算、阻塞與緊急停止。',
    'sidebar.runDesk': '執行桌面',
    'sidebar.runDeskDescription': '深入查看 agent run、workflow 狀態與人工介入。',
    'sidebar.settings': '設定',
    ...
    'workflows.title': '工作流',
    'goals.consoleTitle': '目標主控台',
    'goals.consoleDescription': '進階操作面板，用來檢查長任務、預算、worker 代次、稽核結果與緊急停止。',
    'agentRuns.deskTitle': '執行桌面',
    'agentRuns.deskDescription': '進階 run/operator 面板，用來直接查看 workflow 執行、人工訊息與恢復流程。',
    'agentRuns.badge.chatFirst': 'Chat-first workflow',
    'agentRuns.badge.advanced': 'Advanced run desk',
    ...
    'settings.security.fileReadScope': '檔案讀取範圍',
    'settings.security.fileWriteScope': '檔案寫入範圍',
    ...
    'settings.savedModels.clearApiKey': '清除 API key',
  ...
  en: {
    ...
    'sidebar.primaryHintTitle': 'Chat is the primary surface',
    'sidebar.primaryHintDescription': 'Start and steer goals in chat first. The consoles below stay available for inspection, recovery, and advanced operator work.',
    'sidebar.advancedTools': 'Advanced',
    'sidebar.goalConsole': 'Goal Console',
    'sidebar.goalConsoleDescription': 'Inspect long-running goals, budgets, blockers, and emergency stop controls.',
    'sidebar.runDesk': 'Run Desk',
    'sidebar.runDeskDescription': 'Inspect agent runs, workflow state, and manual intervention tools.',
    ...
    'goals.consoleTitle': 'Goal Console',
    'goals.consoleDescription': 'Advanced operator surface for long-running goals, budgets, worker generations, audit findings, and emergency stop.',
    'agentRuns.deskTitle': 'Run Desk',
    'agentRuns.deskDescription': 'Advanced run/operator surface for direct workflow inspection, manual messaging, and recovery flows.',
    'agentRuns.badge.chatFirst': 'Chat-first workflow',
    'agentRuns.badge.advanced': 'Advanced run desk',
    ...
    'settings.security.fileReadScope': 'File read scope',
    'settings.security.fileWriteScope': 'File write scope',
    ...
    'settings.savedModels.clearApiKey': 'Clear API key',
